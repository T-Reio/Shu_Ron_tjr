...
\begin{itemize}
 ...
 \end{figure}
  ...
  \begin{landscape}
    \input{results/sal_index}
  \end{landscape}



   \begin{landscape}
     \input{results/sal_fwar}

     \include{results/sal_off}
   \end{landscape}
 ...
 \begin{landscape}
   \input{results/sal_fwar_bfst}

   \include{results/sal_bat_bfst}
 \end{landscape}

 \begin{landscape}
   \input{results/sal_fwar_stmb}

   \include{results/sal_bat_stmb}
 \end{landscape}

 \begin{landscape}
   \input{results/sal_fwar_afmb}

   \include{results/sal_bat_afmb}
 \end{landscape}

  \input{results/sal_fwar_didid}
  \input{results/sal_bat_didid}
