...
\noindent
\small
\textbf{JFE Classification:} D91, J01
...
\]
where $F$ stands for the monetary reward function to the player $i$ at time $t+1$, and $X_{it}$ and $Z_{it}$ express the value of the index and other player characteristcs, respectively.
